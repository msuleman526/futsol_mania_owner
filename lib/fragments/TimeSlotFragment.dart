...
import 'package:futsol_mania_owner/Calender/flutter_calendar.dart';
import 'package:futsol_mania_owner/Pages/AddMonthlySlotScreen.dart';
import 'package:futsol_mania_owner/Pages/AddSlotScreen.dart';
import 'package:futsol_mania_owner/Pages/EditSlotScreen.dart';
...
import 'package:futsol_mania_owner/Models/Slot.dart';
...
class _TimeSlotFragmentState extends State<TimeSlotFragment> {
  ...
  Future<Null> getData() async {
    ...
    date = "$day-$month-$year";
      ...
      FirebaseAuth.instance.currentUser().then((user) {
        grounds_db.child(user.uid).child("Slots").child(date).once().then((DataSnapshot datasnapshot) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                              ...
                              return Slidable(
                                  ...
                                  secondaryActions: <Widget>[
                                    ...
                                    IconSlideAction(
                                      ...
                                      icon: Icons.delete,
                                      onTap: () {
                                        deleteSlot(slots[index],context,index);
                                      },
                                    ),
                                  ],
                                  child: listitem(
      ...
      floatingActionButton: Container(
          ...
          Expanded(flex: 1,child: new RaisedButton(
                color: HexColor("39B54A"),
                onPressed: () {
                  addTimeSlot(context);
                },
  ...
  void deleteSlot(Slot slot, BuildContext context,int index) {
    ...
    progressDialog.show();
    FirebaseAuth.instance.currentUser().then((user) {
      grounds_db.child(user.uid).child("Slots").child(slot.date).child(
          slot.slot_id).remove().whenComplete(() {
