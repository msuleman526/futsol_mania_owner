...
import 'package:futsol_mania_owner/Pages/GroundSignUpScreen.dart';
  ...
  void getData() async
  {
    ...
    _user_id = await user_defaults.getUserUserID();
      ...
      FirebaseAuth.instance.currentUser().then((user) {
        ground_owners_db.child(user.uid).once().then((DataSnapshot datasnapshot) {
          ...
          if (_image!=null) {
            ...
            if(taskSnapshot.ref.getDownloadURL() != null)
            {
              ...
              var data ={
               ...
               ground_owners_db.child(_user_id).update(data).whenComplete((){
