...
import 'package:futsol_mania_owner/Pages/EditProfileScreen.dart';
import 'package:futsol_mania_owner/Pages/MainScreen.dart';
import 'package:futsol_mania_owner/Pages/RegisterPlayerScreen.dart';
import 'package:futsol_mania_owner/Pages/RegisterTeamScreen.dart';
import 'package:futsol_mania_owner/fragments/ChallengeListFragment.dart';
import 'package:futsol_mania_owner/fragments/TeamListFragment.dart';
import 'package:futsol_mania_owner/utils/HexColor.dart';
import 'package:futsol_mania_owner/fragments/TimeSlotFragment.dart';
import 'package:futsol_mania_owner/Pages/EnterPhoneScreen.dart';
import 'package:flutter/services.dart';
import 'package:futsol_mania_owner/utils/ProgressHub.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _getUserData()
  {
    FirebaseAuth.instance.currentUser().then((user) {
      uid = user.uid;
      ground_owners_db.child(uid).orderByPriority().once().then((DataSnapshot datasnapshot)
      {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title: Text("Ground Owner Home",style: TextStyle(color: HexColor("39B54A")),),
          ...
          child: Column(
            children: <Widget>[
              Expanded(
                ...
                child: new ListView(
                  children: <Widget>[
                    new UserAccountsDrawerHeader(accountName: Text(_drawerUserName,style: TextStyle(color: Colors.white),),
                      accountEmail: Text(_drawerUserEmail,style: TextStyle(color: Colors.white)),
                      currentAccountPicture: GestureDetector(child: new CircleAvatar(child:
                      CircleAvatar(
                          backgroundColor:
                          HexColor("ffffff"),
                          radius: 50.0,
                          child: ClipOval(
                            child:
                            (drawer_picture!=null)?Image.network(""+drawer_picture,width: 80,height: 80,fit: BoxFit.cover,)
                                :Image.asset(
                              "assets/logo.png",
                              width: 80.0,
                              height: 80.0,
                    ...
                    InkWell(
                        ...
                        child: ListTile(title: Text("Home Page"),leading: Icon(Icons.home),selected: true,)),
                    InkWell(
                        onTap: () {
                          Navigator.push(context, new MaterialPageRoute(builder: (context) {
                        ...
                        child: ListTile(title: Text("Edit Profile"),leading: Icon(Icons.person_add))),
                    InkWell(
                        onTap: () {
                          Navigator.push(context, new MaterialPageRoute(builder: (context) {
                        ...
                        child: ListTile(title: Text("Edit Ground"),leading: new ImageIcon(new AssetImage("assets/ground.png")))),
                    InkWell(
                        onTap: () {},
                        child: ListTile(title: Text("Settings"),leading: Icon(Icons.settings))),
                    InkWell(
                        onTap: () {},
                        child: ListTile(title: Text("About Us"),leading: Icon(Icons.info_outline))),
                    InkWell(
                        onTap: () {},
                        child:  ListTile(title: Text("Rate Us"),leading: Icon(Icons.rate_review))),
                    InkWell(
                        onTap: () {
                          signOut(context);
                        },
                        child: ListTile(title: Text("Sign Out"),leading: Icon(Icons.power_settings_new)))
